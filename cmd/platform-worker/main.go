...
func main() {
	...
	// See cmd/platform-api/main.go for why this reuses the same global
	// Proxmox configuration as the real InfrastructureProvider client (§12
	// CAPMOX rendering) — zero value when Proxmox isn't configured as "real".
